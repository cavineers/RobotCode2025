...
public class AlgaeBarIOSim implements AlgaeBarIO {
    ...
    private DCMotorSim deployMotor = new DCMotorSim(
        LinearSystemId.createDCMotorSystem(DCMotor.getNEO(1), 0.004, 1 / AlgaeBarConstants.kDeployGearRatio),
        DCMotor.getNEO(1));
    ...
    private LoggedNetworkNumber tuningP = new LoggedNetworkNumber("Tuning/AlgaeBar/P", kProportionalTermSim);
    private LoggedNetworkNumber tuningD = new LoggedNetworkNumber("Tuning/AlgaeBar/I", kDerivativeTermSim);

...
public class SwerveDriveSubsystem extends SubsystemBase {
  ...
  private SwerveDrivePoseEstimator poseEstimator =
      new SwerveDrivePoseEstimator(kinematics, gyroRotation, previousModulePositions, new Pose2d());
  ...
  public SwerveDriveSubsystem(
    ...
    AutoBuilder.configure(
        ...
        (speeds, feedforwards) ->
            driveVelocity(speeds), // Method that will drive the robot given ROBOT
  ...
  public void periodic() {
    ...
    double[] odometryTimestamps =
        modules[0].getOdometryTimestamps(); // Get the timestamps from the first module
    ...
    for (int i = 0; i < sampleCount; i++) {
      ...
      for (int modIndex = 0; modIndex < 4; modIndex++) {
        ...
        moduleDeltas[modIndex] =
            new SwerveModulePosition(
                modulePositions[modIndex].distanceMeters
                    - previousModulePositions[modIndex].distanceMeters,
  ...
  public void driveVelocity(ChassisSpeeds speeds) {
    ...
    SwerveDriveKinematics.desaturateWheelSpeeds(
        moduleStates, DriveConstants.kPhysicalMaxSpeedMetersPerSecond);
